...
export default function Home() {
  ...
  const projects = [
    ...
    { title: "NEW NORMAL", color: "green", description: "Our subconscious has a New Normal! We held on to dear life in ways of the New Normal. New Normal is an immortal and virus-free place that we have created together.", image: NewNormal, side: "right", appStoreLink: "", googlePlayLink: "", youtubeLink: "", link: "https://afterwork.house/newnormal/" },
    ...
    { title: "UNFINISHED", color: "green", description: "THIS PROJECT IS ALSO AN UNFINISHED PROJECT. unfinished project is an exhibition which contains unfinished projects of artists.", image: Unfinished, side: "left", appStoreLink: "", googlePlayLink: "", youtubeLink: "", link: "https://ekinohutcu.itch.io/unfinished" },
